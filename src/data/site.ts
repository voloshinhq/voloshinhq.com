...
export const ui = {
  ru: {
    ...
    hero: {
      ...
      text: 'Делаю практичные инструменты для людей, которые работают за ноутбуками и компьютерами. Пишу о продуктах, инфраструктуре и том, как AI меняет инженерную работу.'
    },
    shift: {
      label: 'Мир изменился',
